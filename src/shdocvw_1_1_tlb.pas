...
//  Imported SHDocVw on 29.08.2016 07:18:28 from C:\Windows\SysWOW64\ieframe.dll
...
Const
  ...
  IID_IShellUIHelper7 : TGUID = '{66DEBCF2-05B0-4F07-B49B-B96241A65DB2}';
...
// IShellUIHelper7 : Shell UI Helper Control Interface 7
 ...
 IShellUIHelper7Disp = dispinterface
   ...
   procedure msLaunchInternetOptions;dispid 74;
    // GetCVListData :  
   function GetCVListData:WideString;dispid 84;
    // GetCVListLocalData :  
   function GetCVListLocalData:WideString;dispid 85;
    // GetEMIEListData :  
   function GetEMIEListData:WideString;dispid 86;
    // GetEMIEListLocalData :  
   function GetEMIEListLocalData:WideString;dispid 87;
  end;
...
//CoClasses
  ...
  Public
    Class Function Create: IShellUIHelper7;
    Class Function CreateRemote(const MachineName: string): IShellUIHelper7;
  end;
...
Class Function CoShellUIHelper.Create: IShellUIHelper7;
begin
  Result := CreateComObject(CLASS_ShellUIHelper) as IShellUIHelper7;
end;

Class Function CoShellUIHelper.CreateRemote(const MachineName: string): IShellUIHelper7;
begin
  Result := CreateRemoteComObject(MachineName,CLASS_ShellUIHelper) as IShellUIHelper7;
end;
